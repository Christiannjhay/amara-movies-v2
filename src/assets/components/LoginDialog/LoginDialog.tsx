            ...
            <Card className="bg-[#181818] border-none">
              ...
              <CardContent className="space-y-2">
                ...
                <div className="space-y-1">
                  ...
                  <Input id="password" defaultValue="" type="password" className="bg-[#27272A] rounded-2xl border-[#FF3131]" />
                </div>
              </CardContent>
              <CardFooter>
            ...
            <Card className="bg-[#181818] border-none">
              ...
              <CardContent className="space-y-2">
                <div className="space-y-1">
                  ...
                  <Input id="username" type="text" className="bg-[#27272A] rounded-2xl border-[#FF3131]" />
                </div>
                <div className="space-y-1">
                  <Label htmlFor="password" className="text-white">Password</Label>
                  <Input id="password" type="password" className="bg-[#27272A] rounded-2xl border-[#FF3131]" />
                </div>
              </CardContent>
              <CardFooter>
